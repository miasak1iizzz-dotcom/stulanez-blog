---
title: "友情链接"
description: "在彼此的小站里，留下一条通往对方的路"
---
...
export const site = {
  name: "永恒欲望",
  desc: "慢慢写下代码、生活和还想继续做的事。",
  url: "https://stulanez.com",
  avatar: "https://stulanez.com/assets/images/avatar.jpg",
  email: "",
};
...
export const notes = [
  { title: "彼此可见", content: "申请前请先添加本站；确认信息无误后，我也会把你放进这里" },
  { title: "真实表达", content: "欢迎有原创内容和个人气息的小站，不要求更新频率或访问量" },
  { title: "稳定访问", content: "站点需要支持 HTTPS 并能够正常访问，链接或头像变更时可以随时留言" },
  { title: "友善安全", content: "请勿包含违法、仇恨、色情或其他可能伤害访问者的内容" },
];
      ...
      <div class="p-5 sm:p-6 flex flex-col flex-1">
        ...
        <div class="space-y-0 flex-1">
          ...
          <div class="flex gap-3.5">
            ...
            <div class="pb-4">
              <p class="font-semibold text-sm mb-1">先添加本站</p>
              <p class="text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed">把左侧信息加入你的友链页，各字段都可以直接复制</p>
            </div>
          </div>
          ...
          <div class="flex gap-3.5">
            ...
            <div class="pb-4">
              <p class="font-semibold text-sm mb-1">留下你的信息</p>
              <p class="text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed">复制并填写下面的模板，然后发到 <a href="/guestbook/">留言板</a></p>
          ...
          <div class="flex gap-3.5">
            ...
            <div>
              <p class="font-semibold text-sm mb-1">等我来串门</p>
              <p class="text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed">确认站点可以访问、信息无误后，我会尽快添加友链</p>
            </div>
          </div>
        </div>
      </div>
