...
export const zh_CN: Translation = {
	...
	[Key.hitokoto]: "今日一言",
	[Key.clock]: "现在",
	[Key.clockFetching]: "正在获取时间...",
	[Key.timeProgress]: "时间进度",
	[Key.timeProgressYear]: "本年",
	[Key.timeProgressMonth]: "本月",
	[Key.timeProgressWeek]: "本周",
	[Key.timeProgressYearLeft]: "本年还剩 {days} 天",
	[Key.timeProgressMonthLeft]: "本月还剩 {days} 天",
	[Key.timeProgressWeekLeft]: "本周还剩 {days} 天",
	[Key.timeProgressNext]: "距离下一站",
	[Key.timeProgressDays]: "天",
	[Key.greetingMorning]: "早上好",
	[Key.greetingNoon]: "中午好",
	[Key.greetingAfternoon]: "下午好",
	[Key.greetingEvening]: "晚上好",
	[Key.greetingNight]: "夜深了",
	[Key.welcomeToastLabel]: "WELCOME",
	[Key.welcomeToastHello]: "{greeting}，欢迎来到永恒欲望。",
	[Key.welcomeToastHelloCity]:
		"{greeting}，来自{city}的朋友。欢迎来到永恒欲望。",
	[Key.welcomeToastBody]: "很高兴在这里遇见你。",
	[Key.welcomeToastMore]: "了解更多",
	[Key.welcomeToastClose]: "关闭欢迎提示",
