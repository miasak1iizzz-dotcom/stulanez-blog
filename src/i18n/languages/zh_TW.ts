...
export const zh_TW: Translation = {
	...
	[Key.splashPreviewHint]: "在首頁切換角色或橫幅，會立即播放一次動畫預覽。",
	...
	[Key.hitokoto]: "今日一言",
	[Key.clock]: "現在",
	[Key.clockFetching]: "正在取得時間...",
	[Key.timeProgress]: "時間進度",
	[Key.timeProgressYear]: "本年",
	[Key.timeProgressMonth]: "本月",
	[Key.timeProgressWeek]: "本週",
	[Key.timeProgressYearLeft]: "本年還剩 {days} 天",
	[Key.timeProgressMonthLeft]: "本月還剩 {days} 天",
	[Key.timeProgressWeekLeft]: "本週還剩 {days} 天",
	[Key.timeProgressNext]: "距離下一站",
	[Key.timeProgressDays]: "天",
	[Key.greetingMorning]: "早安",
	[Key.greetingNoon]: "午安",
	[Key.greetingAfternoon]: "下午好",
	[Key.greetingEvening]: "晚上好",
	[Key.greetingNight]: "夜深了",
	[Key.welcomeToastLabel]: "WELCOME",
	[Key.welcomeToastHello]: "{greeting}，歡迎來到永恆欲望。",
	[Key.welcomeToastHelloCity]:
		"{greeting}，來自{city}的朋友。歡迎來到永恆欲望。",
	[Key.welcomeToastBody]: "很高興在這裡遇見你。",
	[Key.welcomeToastMore]: "了解更多",
	[Key.welcomeToastClose]: "關閉歡迎提示",
