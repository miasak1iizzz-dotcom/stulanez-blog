...
export const ru: Translation = {
	...
	[Key.hitokoto]: "Фраза дня",
	[Key.clock]: "Сейчас",
	[Key.clockFetching]: "Получение времени...",
	[Key.timeProgress]: "Ход времени",
	[Key.timeProgressYear]: "Этот год",
	[Key.timeProgressMonth]: "Этот месяц",
	[Key.timeProgressWeek]: "Эта неделя",
	[Key.timeProgressYearLeft]: "До конца года {days} дн.",
	[Key.timeProgressMonthLeft]: "До конца месяца {days} дн.",
	[Key.timeProgressWeekLeft]: "До конца недели {days} дн.",
	[Key.timeProgressNext]: "До следующей даты",
	[Key.timeProgressDays]: "дн.",
	[Key.greetingMorning]: "Доброе утро",
	[Key.greetingNoon]: "Добрый день",
	...
	[Key.welcomeToastHello]: "{greeting}. Добро пожаловать в 永恒欲望.",
	[Key.welcomeToastHelloCity]:
		"{greeting}, друг из {city}. Добро пожаловать в 永恒欲望.",
	[Key.welcomeToastBody]: "Рад встрече здесь.",
	[Key.welcomeToastMore]: "Узнать больше",
	[Key.welcomeToastClose]: "Закрыть приветствие",
