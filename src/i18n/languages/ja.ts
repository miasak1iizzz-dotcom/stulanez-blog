...
export const ja: Translation = {
	...
	[Key.hitokoto]: "今日の一言",
	[Key.clock]: "いま",
	[Key.clockFetching]: "時刻を取得しています...",
	[Key.timeProgress]: "時間の進み",
	[Key.timeProgressYear]: "今年",
	[Key.timeProgressMonth]: "今月",
	[Key.timeProgressWeek]: "今週",
	[Key.timeProgressYearLeft]: "今年はあと {days} 日",
	[Key.timeProgressMonthLeft]: "今月はあと {days} 日",
	[Key.timeProgressWeekLeft]: "今週はあと {days} 日",
	[Key.timeProgressNext]: "次の節目まで",
	[Key.timeProgressDays]: "日",
	[Key.greetingMorning]: "おはようございます",
	[Key.greetingNoon]: "こんにちは",
	[Key.greetingAfternoon]: "こんにちは",
	[Key.greetingEvening]: "こんばんは",
	[Key.greetingNight]: "夜も更けました",
	[Key.welcomeToastLabel]: "WELCOME",
	[Key.welcomeToastHello]: "{greeting}。永恒欲望へようこそ。",
	[Key.welcomeToastHelloCity]:
		"{greeting}、{city} から来た友人。永恒欲望へようこそ。",
	[Key.welcomeToastBody]: "ここで会えてうれしいです。",
	[Key.welcomeToastMore]: "もっと見る",
	[Key.welcomeToastClose]: "ようこそ案内を閉じる",
