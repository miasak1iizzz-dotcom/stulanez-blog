...
export const ko: Translation = {
	...
	[Key.changelog]: "변경 로그",
	[Key.changelogDescription]: "이 사이트가 조금씩 자라는 기록",
	[Key.untitled]: "제목 없음",
	...
	[Key.hitokoto]: "오늘의 한 줄",
	[Key.clock]: "지금",
	[Key.clockFetching]: "시간을 가져오는 중...",
	[Key.timeProgress]: "시간 진행",
	[Key.timeProgressYear]: "올해",
	[Key.timeProgressMonth]: "이번 달",
	[Key.timeProgressWeek]: "이번 주",
	[Key.timeProgressYearLeft]: "올해 {days}일 남음",
	[Key.timeProgressMonthLeft]: "이번 달 {days}일 남음",
	[Key.timeProgressWeekLeft]: "이번 주 {days}일 남음",
	[Key.timeProgressNext]: "다음 일정까지",
	[Key.timeProgressDays]: "일",
	[Key.greetingMorning]: "좋은 아침",
	[Key.greetingNoon]: "좋은 점심",
	[Key.greetingAfternoon]: "좋은 오후",
	[Key.greetingEvening]: "좋은 저녁",
	[Key.greetingNight]: "늦은 밤입니다",
	[Key.welcomeToastLabel]: "WELCOME",
	[Key.welcomeToastHello]: "{greeting}. 永恒欲望에 오신 것을 환영합니다.",
	[Key.welcomeToastHelloCity]:
		"{greeting}, {city}에서 온 친구. 永恒欲望에 오신 것을 환영합니다.",
	[Key.welcomeToastBody]: "여기서 만나게 되어 반갑습니다.",
	[Key.welcomeToastMore]: "더 알아보기",
	[Key.welcomeToastClose]: "환영 안내 닫기",
